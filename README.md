...
我也核过 WIPO / Google Patents / Espacenet 这类国外站点。

结论是：

- 它们适合做中国专利的法律状态交叉核验
- 但对你这个“地级市 year-city 面板 + 排除未缴费终止”的目标，通常不比 CNIPA 官方系统更省事
- 关键原因是：城市级地址字段不稳定，批量覆盖和可审计性也不如 CNIPA 官方源

所以国外站点更适合补充核验，不建议作为主数据源。
